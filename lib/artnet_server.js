...
var msgFormatHeader = '!7sBHHBBHH'
// // Payload is between 2 and 512, so this is the maximal payload (can be trimmed later if necessary)
var msgFormatMaxPayload = ''
...
exports.listen = function(port, cb) {
	...
	var sock = dgram.createSocket("udp4", function (msg, peer) {
		...
		// Protocol Data
		var unpacked = jspack.Unpack(msgFormatHeader, msg, 0);
		var signature = unpacked[0];		// Signature should be 'Art-Net'
		var zero = unpacked[1];				// It's just a zero per the format definition ;-)
		...
		var payloadFormat = msgFormatMaxPayload.substring(0, length);
